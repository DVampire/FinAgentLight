...
class LLMConfig:
    ...
    Attributes:
        ...
        custom_llm_provider: The custom LLM provider to use. This is undocumented in omninexus, and normally not used. It is documented on the litellm side.
        ...
        draft_editor: A more efficient LLM to use for file editing. Introduced in [PR 3985](https://github.com/All-Hands-AI/omninexus/pull/3985).
    """
    ...
    openrouter_app_name: str = 'omninexus'
    num_retries: int = 8
    retry_multiplier: float = 2
    retry_min_wait: int = 15
    retry_max_wait: int = 120
    timeout: int | None = None
    max_message_chars: int = 200_000  # maximum number of characters in an observation's content when sent to the llm
