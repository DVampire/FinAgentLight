...
from finagentlight.utils.exceptions import CloudFlareBlockageError
from finagentlight.utils.fn_call_converter import (
    STOP_WORDS,
...
from finagentlight.utils.mixin import DebugMixin, RetryMixin
...
class LLM(RetryMixin, DebugMixin):
    ...
    def __init__(
        ...
        self.metrics: LLMMetrics = (
            metrics if metrics is not None else LLMMetrics(model_name=config.model)
        )
